# Define the URL for the Angular EOL dates page
$url = "https://endoflife.date/api/angular.json"
...
$outputFile = "$outputDirectory\angular.json"
...
Write-Output "Angular EOL dates have been saved to $outputFile"
